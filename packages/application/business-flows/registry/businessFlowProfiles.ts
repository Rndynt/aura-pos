...
export const BUSINESS_FLOW_PROFILES: Record<BusinessFlowProfileId, BusinessFlowProfileDefinition> = {
  ...
  food_beverage: {
    ...
    uiSections: ["PRODUCT_GRID", "CART", "PAYMENT", "SERVER_DRAFTS", "LOCAL_DRAFTS", "RECEIPTS"],
    defaultActions: baselineActions,
    optionalActions: [...optionalFinancialActions, "SEND_TO_KITCHEN", "PAY_ACTIVE_ORDER", "ADD_ITEM_TO_ACTIVE_ORDER", "CREATE_PREPARATION_TICKET_AFTER_PAYMENT", "VIEW_ACTIVE_ORDER"],
    businessSpecificActions: ["SEND_TO_KITCHEN", "PAY_ACTIVE_ORDER", "ADD_ITEM_TO_ACTIVE_ORDER", "CREATE_PREPARATION_TICKET_AFTER_PAYMENT", "VIEW_ACTIVE_ORDER"],
    coreActions: ["CREATE_AND_PAY", "SAVE_DRAFT", "CONTINUE_DRAFT", "UPDATE_DRAFT_ITEMS"],
  ...
  service: {
    ...
    uiSections: ["PRODUCT_GRID", "CART", "PAYMENT", "SERVER_DRAFTS", "LOCAL_DRAFTS", "RECEIPTS"],
    defaultActions: baselineActions,
    optionalActions: [...optionalFinancialActions, "PAY_ACTIVE_ORDER", "VIEW_ACTIVE_ORDER"],
    businessSpecificActions: ["PAY_ACTIVE_ORDER", "VIEW_ACTIVE_ORDER"],
    coreActions: ["CREATE_AND_PAY", "SAVE_DRAFT", "CONTINUE_DRAFT", "UPDATE_DRAFT_ITEMS"],
