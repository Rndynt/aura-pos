export const ENTITLEMENT_CATALOG = {
  ...
  entitlements: {
    ...
    restaurant_table_service: { label: 'Layanan Meja', kind: 'module', area: 'restaurant' },
    restaurant_kitchen_ops: { label: 'Operasional Dapur', kind: 'module', area: 'restaurant' },
    reports_advanced: { label: 'Laporan Lanjutan', kind: 'feature', area: 'reports' },
    reports_export: { label: 'Ekspor Laporan', kind: 'feature', area: 'reports' },
    multi_location: { label: 'Multi Lokasi', kind: 'module', area: 'multi_location' },
